...
INSERT INTO tblUser (	noEmploye	,	prenomNom			,	motPasse	,	xpTotal	,	dateEmbaudhe	,	gold	)	Values
					(	'1'			,	'Ananseth'			,	'motpasse'	,	559		,	'2010-12-08'	,	49		)	,
					(	'2'			,	'Anoshnornar'		,	'motpasse'	,	1410	,	'2012-11-19'	,	119		)	,
					(	'3'			,	'Ashariya'			,	'motpasse'	,	819		,	'2018-06-18'	,	11		)	,
					(	'4'			,	'Ashersan'			,	'motpasse'	,	1068	,	'2018-10-05'	,	102		)	,
					(	'5'			,	'Cersil'			,	'motpasse'	,	939		,	'2011-09-20'	,	21		)	,
					(	'6'			,	'Charosshen'		,	'motpasse'	,	878		,	'2012-08-12'	,	80		)	,
					(	'7'			,	'Chenassean'		,	'motpasse'	,	154		,	'2010-01-31'	,	145		)	,
					(	'8'			,	'Cheroshu'			,	'motpasse'	,	496		,	'2013-05-23'	,	53		)	,
					(	'9'			,	'Chyshysseth'		,	'motpasse'	,	1005	,	'2015-03-28'	,	33		)	,
					(	'10'		,	'Hynser'			,	'motpasse'	,	1985	,	'2011-12-02'	,	156		)	,
					(	'11'		,	'Hysnor'			,	'motpasse'	,	1264	,	'2015-10-01'	,	36		)	,
					(	'12'		,	'Hædarshen'			,	'motpasse'	,	1160	,	'2012-07-20'	,	153		)	,
					(	'13'		,	'Iseshisha'			,	'motpasse'	,	798		,	'2010-06-25'	,	119		)	,
					(	'14'		,	'Shamusnorser'		,	'motpasse'	,	138		,	'2018-05-18'	,	24		)	,
					(	'15'		,	'Shamyssila'		,	'motpasse'	,	514		,	'2014-02-04'	,	182		)	,
					(	'16'		,	'Shanyseannar'		,	'motpasse'	,	897		,	'2019-05-20'	,	130		)	,
					(	'17'		,	'Shariderish'		,	'motpasse'	,	181		,	'2010-03-25'	,	43		)	,
					(	'18'		,	'Shimasashaesh'		,	'motpasse'	,	1458	,	'2019-04-13'	,	54		)	,
					(	'19'		,	'Shoryso'			,	'motpasse'	,	847		,	'2011-09-02'	,	16		)	,
					(	'20'		,	'Shænæseru'			,	'motpasse'	,	1663	,	'2012-07-12'	,	95		)	,
					(	'21'		,	'Solushshœresh'		,	'motpasse'	,	26		,	'2015-09-09'	,	21		)	,
					(	'22'		,	'Solyssin'			,	'motpasse'	,	454		,	'2015-07-23'	,	50		)	,
					(	'23'		,	'Sorosyosha'		,	'motpasse'	,	1216	,	'2011-12-13'	,	9		)	,
					(	'24'		,	'Ushyssir'			,	'motpasse'	,	819		,	'2012-08-04'	,	102		)	,
					(	'25'		,	'Usæyosh'			,	'motpasse'	,	1328	,	'2019-01-22'	,	68		)	,
					(	'26'		,	'Amynder'			,	'motpasse'	,	1063	,	'2011-06-13'	,	41		)	,
					(	'27'		,	'Anisshœrseth'		,	'motpasse'	,	159		,	'2013-06-10'	,	82		)	,
					(	'28'		,	'Ceræsen'			,	'motpasse'	,	1004	,	'2012-11-12'	,	60		)	,
					(	'29'		,	'Cysshel'			,	'motpasse'	,	307		,	'2019-12-12'	,	92		)	,
					(	'30'		,	'Eshæiash'			,	'motpasse'	,	94		,	'2011-01-01'	,	146		)	,
					(	'31'		,	'Esshœr'			,	'motpasse'	,	1368	,	'2010-05-08'	,	135		)	,
					(	'32'		,	'Hushsearsen'		,	'motpasse'	,	397		,	'2018-09-17'	,	8		)	,
					(	'33'		,	'Oshomireily'		,	'motpasse'	,	1004	,	'2013-10-18'	,	121		)	,
					(	'34'		,	'Ososhsuri'			,	'motpasse'	,	1419	,	'2008-11-16'	,	184		)	,
					(	'35'		,	'Sanossirnoreil'	,	'motpasse'	,	704		,	'2018-09-13'	,	18		)	,
					(	'36'		,	'Sarirorsha'		,	'motpasse'	,	1034	,	'2009-07-19'	,	68		)	,
					(	'37'		,	'Seressurnarel'		,	'motpasse'	,	1976	,	'2010-04-04'	,	33		)	,
					(	'38'		,	'Serinoreilel'		,	'motpasse'	,	940		,	'2012-06-23'	,	200		)	,
					(	'39'		,	'Seræsham'			,	'motpasse'	,	981		,	'2019-06-07'	,	114		)	,
					(	'40'		,	'Shamorish'			,	'motpasse'	,	1810	,	'2013-07-31'	,	29		)	,
					(	'41'		,	'Shamunsan'			,	'motpasse'	,	107		,	'2011-11-28'	,	108		)	,
					(	'42'		,	'Shanara'			,	'motpasse'	,	151		,	'2012-12-13'	,	78		)	,
					(	'43'		,	'Shissormireil'		,	'motpasse'	,	1116	,	'2018-08-03'	,	78		)	,
					(	'44'		,	'Sinues'			,	'motpasse'	,	1179	,	'2009-07-16'	,	136		)	,
					(	'45'		,	'Soloelsor'			,	'motpasse'	,	1650	,	'2009-07-05'	,	46		)	,
					(	'46'		,	'Sorarorsha'		,	'motpasse'	,	1322	,	'2015-03-28'	,	15		)	,
					(	'47'		,	'Soronas'			,	'motpasse'	,	316		,	'2009-11-23'	,	151		)	,
					(	'48'		,	'Yshisearishæ'		,	'motpasse'	,	204		,	'2013-01-21'	,	21		)	,
					(	'49'		,	'Œonsan'			,	'motpasse'	,	343		,	'2010-05-06'	,	58		)	,
					(	'50'		,	'Æeyeaes'			,	'motpasse'	,	1120	,	'2015-03-07'	,	181		)	
